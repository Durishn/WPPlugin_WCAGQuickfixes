# Site-specific CSS and JS examples
Instead of dumping any and all fixes into this plugin, only generalized fixes have been set as the default. Here are some site-specific fixes that may be useful for you:
